...
const TRANSLATIONS = {
  'zh-CN': {
    ...
    'record.add.title': '添加新比赛',
    'record.add.players.hint': '点击选手名字依次切换：未选 → A队 → B队 → 未选',
    'record.add.counts_line': 'A 队 {a} 人 · B 队 {b} 人',
    'record.add.counts': '本场计入积分（取消勾选则只更新胜率，不发放积分）',
    'record.add.submit': '✅ 添加这场比赛',
    'record.list.title': '已记录的比赛',
    'record.list.empty': '尚未添加任何比赛。',
  ...
  'en-US': {
    ...
    'setup.section.attendees': "1. This week's attendees",
    'setup.attendees.selected': '{n} selected',
    'setup.attendees.quickadd.placeholder': 'Quick add a new player',
    'setup.section.params': '2. Match parameters & team draft',
    ...
    'setup.section.recordonly': '3. Record-only mode',
    'setup.recordonly.hint': "Skip the team-formation pipeline and log matches by hand. Each match independently chooses whether it counts for tournament points; win rate and attendance are always recorded.",
    'setup.btn.recordonly': '📝 Record-only mode',
    ...
    'record.add.title': 'Add a new match',
    'record.add.players.hint': 'Tap a player to cycle: unselected → Team A → Team B → unselected',
    'record.add.counts_line': 'Team A: {a} · Team B: {b}',
    'record.add.counts': "This match counts for points (uncheck for win-rate-only)",
    'record.add.submit': '✅ Add this match',
    'record.list.title': 'Recorded matches',
    'record.list.empty': 'No matches recorded yet.',
